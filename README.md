...
Public health monitoring platform developed using React, Node.js, MongoDB, Bootstrap, and D3.js for health trend visualization.

### 🤝 Donation Management Platform
Application connecting donors, volunteers, and organizations through real-time donation matching and community engagement.

### 📱 Android Applications
Mobile applications developed with Kotlin and Jetpack Compose, including calculators, city information apps, and educational projects.

### 💻 Full Stack Development Projects
Projects involving frontend, backend APIs, database integration, authentication, and responsive interfaces.
...
![Snake animation](https://github.com/FabricioGardin/FabricioGardin/blob/output/github-contribution-grid-snake-dark.svg)
